...
TPoint3D PointPlusPoint(TPoint3D t1, TPoint3D t2)
{
	t1.x += t2.x;
	t1.y += t2.y;
	t1.z += t2.z;
...
bool getBitMask(unsigned char mask, int index)
{
	...
	case 2:
		...
		break;
	case 3:
		bitMask = (unsigned char)(8);
		break;
	case 4:
		bitMask = (unsigned char)(16);
		break;
	case 5:
		bitMask = (unsigned char)(32);
		break;
	case 6:
		bitMask = (unsigned char)(64);
		break;
	case 7:
...
unsigned char setBitMask(unsigned char mask, int index, bool set)
{
	unsigned char bitMask = 0;
	if (set) {
		switch (index) {
		...
		switch (index) {
		case 0:
			bitMask = (unsigned char)(254);
			break;
		case 1:
			bitMask = (unsigned char)(253);
			break;
		case 2:
			bitMask = (unsigned char)(251);
			break;
		case 3:
			bitMask = (unsigned char)(247);
			break;
		case 4:
			bitMask = (unsigned char)(239);
			break;
		case 5:
			bitMask = (unsigned char)(223);
			break;
		case 6:
			bitMask = (unsigned char)(191);
			break;
		case 7:
			bitMask = (unsigned char)(127);
			break;
		}
		return mask & bitMask;
	}
